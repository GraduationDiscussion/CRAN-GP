...
void RrSchedulerMemberCschedSapProvider::CschedCellConfigReq(
		const struct CschedCellConfigReqParameters& params,
		const struct CschedCellConfigReqParameters& params2) {
	m_scheduler->DoCschedCellConfigReq(params, params2);
}

void RrSchedulerMemberCschedSapProvider::CschedUeConfigReq(
		const struct CschedUeConfigReqParameters& params,
		const struct CschedUeConfigReqParameters& params2) {
	m_scheduler->DoCschedUeConfigReq(params, params2);
}

void RrSchedulerMemberCschedSapProvider::CschedLcConfigReq(
		const struct CschedLcConfigReqParameters& params,
		const struct CschedLcConfigReqParameters& params2) {
	m_scheduler->DoCschedLcConfigReq(params , params2);
}

void RrSchedulerMemberCschedSapProvider::CschedLcReleaseReq(
		const struct CschedLcReleaseReqParameters& params,
		const struct CschedLcReleaseReqParameters& params2) {
	m_scheduler->DoCschedLcReleaseReq(params , params2);
}

void RrSchedulerMemberCschedSapProvider::CschedUeReleaseReq(
		const struct CschedUeReleaseReqParameters& params,
		const struct CschedUeReleaseReqParameters& params2) {
	m_scheduler->DoCschedUeReleaseReq(params , params2);
}
...
//			const struct SchedDlRlcBufferReqParameters& params2 ,
//			std::list <FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>& m_rlcBufferReq,
...
//----------Modified <Abdelrhman> -------------------------
virtual void SchedDlRlcBufferReq(const struct SchedDlRlcBufferReqParameters& params ,const struct SchedDlRlcBufferReqParameters& params2 );
...
//=====================================================================================================
	//------Modified ------------------
	virtual void SchedDlTriggerReq(const struct SchedDlTriggerReqParameters& params ,const struct SchedDlTriggerReqParameters& params2);

	virtual void SchedDlRachInfoReq(const struct SchedDlRachInfoReqParameters& params,const struct SchedDlRachInfoReqParameters& params2);

	virtual void SchedDlCqiInfoReq(const struct SchedDlCqiInfoReqParameters& params , const struct SchedDlCqiInfoReqParameters& params2);

	virtual void SchedUlTriggerReq(const struct SchedUlTriggerReqParameters& params , const struct SchedUlTriggerReqParameters& params2);
//=================================================================================
//-------Not implemented
...
//========================================
	//---------MOdified ----------------
	virtual void SchedUlMacCtrlInfoReq(const struct SchedUlMacCtrlInfoReqParameters& params , const struct SchedUlMacCtrlInfoReqParameters& params2);

	virtual void SchedUlCqiInfoReq(const struct SchedUlCqiInfoReqParameters& params , const struct SchedUlCqiInfoReqParameters& params2);
//========================================
private:
...
//	m_scheduler->DoSchedDlRlcBufferReq(params2 ,m_rlcBufferReq2 ,m_p10CqiRxed2 ,  m_p10CqiTimers2);
//}
//
//
////------MOd. end
...
//---------Modified <Abdelrhman> ------------
void RrSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (
 const struct SchedDlRlcBufferReqParameters& params , const struct SchedDlRlcBufferReqParameters& params2){

	m_scheduler->DoSchedDlRlcBufferReq(params ,params2);
...
void RrSchedulerMemberSchedSapProvider::SchedDlTriggerReq(
		const struct SchedDlTriggerReqParameters& params,const struct SchedDlTriggerReqParameters& params2) {
	m_scheduler->DoSchedDlTriggerReq(params,params2);
}

void RrSchedulerMemberSchedSapProvider::SchedDlRachInfoReq(
		const struct SchedDlRachInfoReqParameters& params ,
		const struct SchedDlRachInfoReqParameters& params2) {
	m_scheduler->DoSchedDlRachInfoReq(params , params2);
}

void RrSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq(
		const struct SchedDlCqiInfoReqParameters& params , const struct SchedDlCqiInfoReqParameters& params2) {
	m_scheduler->DoSchedDlCqiInfoReq(params ,params);
}

void RrSchedulerMemberSchedSapProvider::SchedUlTriggerReq(
		const struct SchedUlTriggerReqParameters& params, const struct SchedUlTriggerReqParameters& params2) {
	m_scheduler->DoSchedUlTriggerReq(params, params2);
}
...
void RrSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq(
		...
		const struct SchedUlMacCtrlInfoReqParameters& params2) {
	m_scheduler->DoSchedUlMacCtrlInfoReq(params , params2);
}

void RrSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq(
		const struct SchedUlCqiInfoReqParameters& params,
		const struct SchedUlCqiInfoReqParameters& params2)
{

	m_scheduler->DoSchedUlCqiInfoReq(params , params2);
}
...
//  m_cschedSapProvider = new RrSchedulerMemberCschedSapProvider (this);
  ...
  //m_schedSapProvider = new RrFfMacScheduler::RrSchedulerMemberSchedSapProvider (this);
}
//RrFfMacScheduler::RrFfMacScheduler() :
//		m_cschedSapUser(0),m_cschedSapUser2(0),
//		m_schedSapUser(0),m_cschedSapUser2(0),
//		m_nextRntiDl(0), m_nextRntiDl2(0),
//		m_nextRntiUl(0),m_nextRntiUl2(0) {
//	m_amc = CreateObject<LteAmc>();
...
void RrFfMacScheduler::DoCschedCellConfigReq(
		...
		const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params2) {
	NS_LOG_FUNCTION(this);
	// Read the subset of parameters used
	m_cschedCellConfig = params;
	//------
	m_cschedCellConfig2 = params2;
	//-----
...
void RrFfMacScheduler::DoCschedUeConfigReq(
		...
		const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params2) {
	NS_LOG_FUNCTION(
			this << "first phy :- "<<" RNTI " << params.m_rnti << " txMode " << (uint16_t)params.m_transmissionMode << "Second phy :-" " RNTI " << params2.m_rnti << " txMode " << (uint16_t)params2.m_transmissionMode);

	std::map<uint16_t, uint8_t>::iterator it = m_uesTxMode.find(params.m_rnti);
	if (it == m_uesTxMode.end()) {
		m_uesTxMode.insert(
				std::pair<uint16_t, double>(params.m_rnti,
	...
	std::map<uint16_t, uint8_t>::iterator it2 = m_uesTxMode.find(params.m_rnti);
	if (it2 == m_uesTxMode2.end()) {
		m_uesTxMode2.insert(
				std::pair<uint16_t, double>(params2.m_rnti,
						params2.m_transmissionMode));

		// generate HARQ buffers
		m_dlHarqCurrentProcessId2.insert(
				std::pair<uint16_t, uint8_t>(params2.m_rnti, 0));
		DlHarqProcessesStatus_t dlHarqPrcStatus2;
		dlHarqPrcStatus2.resize(8, 0);
		m_dlHarqProcessesStatus2.insert(
				std::pair<uint16_t, DlHarqProcessesStatus_t>(params2.m_rnti,
						dlHarqPrcStatus2));
		DlHarqProcessesTimer_t dlHarqProcessesTimer2;
		dlHarqProcessesTimer2.resize(8, 0);
		m_dlHarqProcessesTimer2.insert(
				std::pair<uint16_t, DlHarqProcessesTimer_t>(params2.m_rnti,
						dlHarqProcessesTimer2));
		DlHarqProcessesDciBuffer_t dlHarqdci2;
		dlHarqdci2.resize(8);
		m_dlHarqProcessesDciBuffer.insert(
				std::pair<uint16_t, DlHarqProcessesDciBuffer_t>(params2.m_rnti,
						dlHarqdci2));
		...
		m_dlHarqProcessesRlcPduListBuffer2.insert(
				std::pair<uint16_t, DlHarqRlcPduListBuffer_t>(params2.m_rnti,
						dlHarqRlcPdu2));
		...
		m_ulHarqProcessesStatus2.insert(
				std::pair<uint16_t, UlHarqProcessesStatus_t>(params2.m_rnti,
						ulHarqPrcStatus2));
		UlHarqProcessesDciBuffer_t ulHarqdci2;
		ulHarqdci2.resize(8);
		m_ulHarqProcessesDciBuffer2.insert(
				std::pair<uint16_t, UlHarqProcessesDciBuffer_t>(params2.m_rnti,
						ulHarqdci2));
	} else {
		(*it2).second = params2.m_transmissionMode;
	}
	//-----------------------------------------
	///////////////////////////////////////////////////////
	return;
...
void RrFfMacScheduler::DoCschedLcConfigReq(
		...
		const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params2) {
	NS_LOG_FUNCTION(this);
...
void RrFfMacScheduler::DoCschedLcReleaseReq(
		...
		const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params2) {
	NS_LOG_FUNCTION(this);
...
//--------------------------------------
	for (uint16_t i = 0; i < params2.m_logicalChannelIdentity.size(); i++) {
		std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it =
				m_rlcBufferReq2.begin();
		while (it != m_rlcBufferReq2.end()) {
			if (((*it).m_rnti == params2.m_rnti)
					&& ((*it).m_logicalChannelIdentity
							== params2.m_logicalChannelIdentity.at(i))) {
...
void RrFfMacScheduler::DoCschedUeReleaseReq(
		...
		const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params2) {
	NS_LOG_FUNCTION(
			this << "For phy1 :-"<< " Release RNTI " << params.m_rnti << "*************      For phy2 :-"<< " Release RNTI " << params2.m_rnti);
	...
	//------------------------------
	m_uesTxMode2.erase(params2.m_rnti);
	m_dlHarqCurrentProcessId2.erase(params2.m_rnti);
	m_dlHarqProcessesStatus2.erase(params2.m_rnti);
	m_dlHarqProcessesTimer2.erase(params2.m_rnti);
	m_dlHarqProcessesDciBuffer2.erase(params2.m_rnti);
	m_dlHarqProcessesRlcPduListBuffer2.erase(params2.m_rnti);
	m_ulHarqCurrentProcessId2.erase(params2.m_rnti);
	m_ulHarqProcessesStatus2.erase(params2.m_rnti);
	m_ulHarqProcessesDciBuffer2.erase(params2.m_rnti);
	m_ceBsrRxed2.erase(params2.m_rnti);
	//------------------------------
 ...
 it = m_rlcBufferReq2.begin();
	...
	if (m_nextRntiUl2 == params2.m_rnti) {
		m_nextRntiUl2 = 0;
	}

	if (m_nextRntiDl2 == params2.m_rnti) {
		m_nextRntiDl2 = 0;
	}
	//----------------------------------------
...
void RrFfMacScheduler::DoSchedDlRlcBufferReq(
		const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params ,
		const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params2){

	NS_LOG_FUNCTION(this << "<phy1>" << params.m_rnti << (uint32_t) params.m_logicalChannelIdentity);
...
////////////////////////////////////////////////////////////////////////////////
	//-------------------------------------------------------
	NS_LOG_FUNCTION(this << "<phy2>" << params2.m_rnti << (uint32_t) params2.m_logicalChannelIdentity);
		// API generated by RLC for updating RLC parameters on a LC (tx and retx queues)
        it = m_rlcBufferReq2.begin();
		 newLc = true;
		while (it != m_rlcBufferReq2.end()) {
			...
			if (((*it).m_rnti == params2.m_rnti)
					&& ((*it).m_logicalChannelIdentity
							== params2.m_logicalChannelIdentity)) {
				it = m_rlcBufferReq2.erase(it);
				newLc = false;          // found
			} else {
				++it;
		...
		// add the new parameters
		m_rlcBufferReq2.insert(it, params2);
		...
		if (newLc == true) // this Ue with the given Rnti not found among the LCs so insert it new lc and initialize it
			...
			// initialized to 1 (i.e., the lowest value for transmitting a signal)
			m_p10CqiTimers.insert(std::pair<uint16_t, uint32_t>(params2.m_rnti,m_cqiTimersThreshold));
		}
...
//----------Modified <Abdelrhman> ------------------//
//---------------------------------------------------
void RrFfMacScheduler::DoSchedDlTriggerReq(const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params ,const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params2 )



{
	NS_LOG_FUNCTION(this << " DL Frame no. " << (params.m_sfnSf >> 4) << " subframe no. " << (0xF & params.m_sfnSf));
	//NS_LOG_FUNCTION(this << " DL Frame no. " << (params2.m_sfnSf >> 4) << " subframe no. " << (0xF & params2.m_sfnSf));
	// API generated by RLC for triggering the scheduling of a DL subframe

	RefreshDlCqiMaps();    // ---  does it need duplication ???
	...
	FfMacSchedSapUser::SchedDlConfigIndParameters ret , ret2;
	...
	std::map<uint16_t, uint8_t>::iterator itProcId2;
		for (itProcId2 = m_ulHarqCurrentProcessId2.begin();
				itProcId2 != m_ulHarqCurrentProcessId2.end(); itProcId2++) {
	...
	m_rachAllocationMap2.resize(m_cschedCellConfig2.m_ulBandwidth, 0);
	uint16_t rbStart2 = 0;
	std::vector<struct RachListElement_s>::iterator itRach2;
	//------------------------------
	...
	for (itRach = m_rachList2.begin(); itRach != m_rachList2.end(); itRach++){
		...
		///////////////////
		NS_ASSERT_MSG(
				m_amc2->GetTbSizeFromMcs(m_ulGrantMcs,m_cschedCellConfig2.m_ulBandwidth)
						> (*itRach).m_estimatedSize,
				" Default UL Grant MCS does not allow to send RACH messages");
		//////////////////////
		...
		while ((tbSizeBits < (*itRach).m_estimatedSize)
			...
			rbLen++;
			tbSizeBits = m_amc2->GetTbSizeFromMcs(m_ulGrantMcs, rbLen);
		}
		if (tbSizeBits < (*itRach).m_estimatedSize) {
			// no more allocation space: finish allocation
			break;
		}
		newRar.m_grant.m_rbStart = rbStart2;
		newRar.m_grant.m_rbLen = rbLen;
		newRar.m_grant.m_tbSize = tbSizeBits / 8;
		newRar.m_grant.m_hopping = false;
		newRar.m_grant.m_tpc = 0;
		...
		for (uint16_t i = rbStart2; i < rbStart2 + rbLen; i++) {
		...
		rbStart = rbStart + rbLen;
		ret2.m_buildRarList.push_back(newRar);
	}
	//-------------------------------------------------
   ...
   //---------
	...
	if (m_dlInfoListBuffered2.size() > 0) {
			if (params2.m_dlInfoList.size() > 0) {
				NS_LOG_INFO(this << "<phy2> Received DL-HARQ feedback");
				m_dlInfoListBuffered2.insert(m_dlInfoListBuffered2.end(),
						params2.m_dlInfoList.begin(), params2.m_dlInfoList.end());
			}
		} else {
			if (params2.m_dlInfoList.size() > 0) {
				m_dlInfoListBuffered2 = params2.m_dlInfoList;
			}
		}
	//-----------------------------------
...
////--->>second phy. list
		...
		if (retx.at(0) || retx.at(1)) {
			...
			if (rv == 3) {
				...
				if (it == m_dlHarqProcessesStatus2.end()) {
					NS_LOG_ERROR(
							"<phy2> No info find in HARQ buffer for UE (might change eNB) " << m_dlInfoListBuffered.at (i).m_rnti);
				}
				(*it).second.at(harqId) = 0;
				std::map<uint16_t, DlHarqRlcPduListBuffer_t>::iterator itRlcPdu =
				...
				if (itRlcPdu == m_dlHarqProcessesRlcPduListBuffer2.end()) {
					NS_FATAL_ERROR(
							"<phy2> Unable to find RlcPdcList in HARQ buffer for RNTI " << m_dlInfoListBuffered.at (i).m_rnti);
				}
				for (uint16_t k = 0; k < (*itRlcPdu).second.size(); k++) {
					(*itRlcPdu).second.at(k).at(harqId).clear();
				}
			...
			(*itHarqTimer).second.at(harqId) = 0;
			ret2.m_buildDataList.push_back(newEl);
	...
	if (rbgAllocatedNum2 == rbgNum2) {
			// all the RBGs are already allocated -> exit
			if ((ret2.m_buildDataList.size() > 0)
					|| (ret2.m_buildRarList.size() > 0)) {
				m_schedSapUser2->SchedDlConfigInd(ret2);
			}
			return;
		}
...
//-------------------------------------------------------------------------------------------------
	do {
		...
		newDci.m_harqProcess = UpdateHarqProcessId((*it2).m_rnti);
		newDci.m_resAlloc = 0;
		newDci.m_rbBitmap = 0;
...
void RrFfMacScheduler::DoSchedDlRachInfoReq(
		...
		const struct FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params2
		) {
	NS_LOG_FUNCTION(this);

	m_rachList = params.m_rachList;
	m_rachList2 = params2.m_rachList;
...
RrFfMacScheduler::DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params,
		const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params2)
{
  NS_LOG_FUNCTION (this);
...
//}
  ...
  NS_LOG_FUNCTION ("<Phy2>" << this);
  std::map <uint16_t,uint8_t>::iterator it2;
  for (unsigned int i = 0; i < params2.m_cqiList.size (); i++)
    {
      if ( params2.m_cqiList.at (i).m_cqiType == CqiListElement_s::P10 )
        {
          NS_LOG_LOGIC ("<Phy2> : wideband CQI " <<  (uint32_t) params2.m_cqiList.at (i).m_wbCqi.at (0) << " reported");
          std::map <uint16_t,uint8_t>::iterator it2;
          uint16_t rnti2 = params2.m_cqiList.at (i).m_rnti;
          it2 = m_p10CqiRxed2.find (rnti2);
          if (it2 == m_p10CqiRxed2.end ())
            {
              // create the new entry
              m_p10CqiRxed2.insert ( std::pair<uint16_t, uint8_t > (rnti2, params2.m_cqiList.at (i).m_wbCqi.at (0)) ); // only codeword 0 at this stage (SISO)
              // generate correspondent timer
              m_p10CqiTimers.insert ( std::pair<uint16_t, uint32_t > (rnti2, m_cqiTimersThreshold2)); //m_p10CqiTimers should we create another one ?
            }
          else
            {
              // update the CQI value
              (*it2).second = params2.m_cqiList.at (i).m_wbCqi.at (0);
              // update correspondent timer
              std::map <uint16_t,uint32_t>::iterator itTimers2;
              itTimers2 = m_p10CqiTimers.find (rnti2);
              (*itTimers2).second = m_cqiTimersThreshold2;
            }
        }
      else if ( params2.m_cqiList.at (i).m_cqiType == CqiListElement_s::A30 )
        {
          // subband CQI reporting high layer configured
          // Not used by RR Scheduler
        }
        ...
        {
          NS_LOG_ERROR (this << " <Phy2> : CQI type unknown");
        }
    }
return ;
}
...
RrFfMacScheduler::DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params,
		const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params2)
{
  NS_LOG_FUNCTION (this << "<Phy1>" << " UL - Frame no. " << (params.m_sfnSf >> 4) << " subframe no. " << (0xF & params.m_sfnSf) << " size " << params.m_ulInfoList.size ());
  RefreshUlCqiMaps (); // fizo : modified by abdlrhman to refresh cqi maps of both phys
  // Generate RBs map
 ...
 */
  ...
  NS_LOG_FUNCTION (this << "<Phy2>" << " UL - Frame no. " << (params2.m_sfnSf >> 4) << " subframe no. " << (0xF & params2.m_sfnSf) << " size " << params2.m_ulInfoList.size ());
  // RefreshUlCqiMaps (); // fizo : modified by abdlrhman to refresh cqi maps of both phys , should we call it once or twice?
  // Generate RBs map
  FfMacSchedSapUser::SchedUlConfigIndParameters ret2 ;
  std::vector <bool> rbMap2 ;
  uint16_t rbAllocatedNum2 = 0;
  std::set <uint16_t> rntiAllocated2;
  std::vector <uint16_t> rbgAllocationMap2;
  // update with RACH allocation map
  rbgAllocationMap2 = m_rachAllocationMap2;
  //rbgAllocationMap.resize (m_cschedCellConfig2.m_ulBandwidth, 0);
  m_rachAllocationMap2.clear ();
  m_rachAllocationMap2.resize (m_cschedCellConfig2.m_ulBandwidth, 0);

  rbMap2.resize (m_cschedCellConfig2.m_ulBandwidth, false);
  // remove RACH allocation
  for (uint16_t i = 0; i < m_cschedCellConfig2.m_ulBandwidth; i++)
    {
      if (rbgAllocationMap2.at (i) != 0)
        {
          rbMap2.at (i) = true;
  ...
  if (m_harqOn == true)
    {
      //   Process UL HARQ feedback
      for (uint16_t i = 0; i < params2.m_ulInfoList.size (); i++)
        {
          if (params2.m_ulInfoList.at (i).m_receptionStatus == UlInfoListElement_s::NotOk)
            {
              // retx correspondent block: retrieve the UL-DCI
              uint16_t rnti2 = params2.m_ulInfoList.at (i).m_rnti;
              std::map <uint16_t, uint8_t>::iterator itProcId2 = m_ulHarqCurrentProcessId2.find (rnti2);
              if (itProcId2 == m_ulHarqCurrentProcessId2.end ())
                {
                  NS_LOG_ERROR (" <Phy2> : No info find in HARQ buffer for UE (might change eNB) " << rnti2);
                }
              uint8_t harqId2 = (uint8_t)((*itProcId2).second - HARQ_PERIOD) % HARQ_PROC_NUM;
              NS_LOG_INFO (this << "<Phy2>" << " UL-HARQ retx RNTI " << rnti2 << " harqId " << (uint16_t)harqId2);
              std::map <uint16_t, UlHarqProcessesDciBuffer_t>::iterator itHarq2 = m_ulHarqProcessesDciBuffer2.find (rnti2);
              if (itHarq2 == m_ulHarqProcessesDciBuffer2.end ())
                {
                  NS_LOG_ERROR (" <Phy2> : No info find in UL-HARQ buffer for UE (might change eNB) " << rnti2);
                }
              UlDciListElement_s dci2 = (*itHarq2).second.at (harqId2);
              std::map <uint16_t, UlHarqProcessesStatus_t>::iterator itStat2 = m_ulHarqProcessesStatus2.find (rnti2);
              if (itStat2 == m_ulHarqProcessesStatus2.end ())
                {
                  NS_LOG_ERROR ("<Phy2> : No info find in HARQ buffer for UE (might change eNB) " << rnti2);
                }
              if ((*itStat2).second.at (harqId2) > 3)
                {
                  NS_LOG_INFO (" <Phy2> : Max number of retransmissions reached (UL)-> drop process");
                  continue;
                }
              bool free2 = true;
              for (int j = dci2.m_rbStart; j < dci2.m_rbStart + dci2.m_rbLen; j++)
                {
                  if (rbMap2.at (j) == true)
                    {
                      free2 = false;
                      NS_LOG_INFO (this << " <Phy2> : BUSY " << j);
                    }
                }
              if (free2)
                {
                  ...
                  for (int j = dci2.m_rbStart; j < dci2.m_rbStart + dci2.m_rbLen; j++)
                    {
                      rbMap2.at (j) = true;
                      rbgAllocationMap2.at (j) = dci2.m_rnti;
                      NS_LOG_INFO (" <Phy2> : \tRB " << j);
                      rbAllocatedNum2++;
                    }
                  NS_LOG_INFO (this << " <Phy2> : Send retx in the same RBGs " << (uint16_t)dci2.m_rbStart << " to " << dci2.m_rbStart + dci2.m_rbLen << " RV " << (*itStat2).second.at (harqId2) + 1);
                }
              else
                {
                  NS_LOG_INFO ("<Phy2> : Cannot allocate retx due to RACH allocations for UE " << rnti2);
                  continue;
                }
              dci2.m_ndi = 0;
              // Update HARQ buffers with new HarqId
              (*itStat2).second.at ((*itProcId2).second) = (*itStat2).second.at (harqId2) + 1;
              (*itStat2).second.at (harqId2) = 0;
              (*itHarq2).second.at ((*itProcId2).second) = dci2;
              ret2.m_dciList.push_back (dci2);
              rntiAllocated2.insert (dci2.m_rnti);
            }
        }
    }
  std::map <uint16_t,uint32_t>::iterator it2;
  int nflows2 = 0;

  for (it2 = m_ceBsrRxed2.begin (); it2 != m_ceBsrRxed2.end (); it2++)
    {
      std::set <uint16_t>::iterator itRnti2 = rntiAllocated2.find ((*it2).first);
      // select UEs with queues not empty and not yet allocated for HARQ
      NS_LOG_INFO (this << " <Phy2> : UE " << (*it2).first << " queue " << (*it2).second);
      if (((*it2).second > 0)&&(itRnti2 == rntiAllocated2.end ()))
        {
          nflows2++;
        }
    }
  ...
  if (nflows2 == 0)
    {
      if (ret2.m_dciList.size () > 0)
        {
          m_allocationMaps2.insert (std::pair <uint16_t, std::vector <uint16_t> > (params2.m_sfnSf, rbgAllocationMap2));
          m_schedSapUser2->SchedUlConfigInd (ret2);
        }
      return;  // no flows to be scheduled
    }

  // Divide the remaining resources equally among the active users starting from the subsequent one served last scheduling trigger
  uint16_t rbPerFlow2 = (m_cschedCellConfig2.m_ulBandwidth) / (nflows2 + rntiAllocated2.size ());
  if (rbPerFlow2 < 3)
    {
      rbPerFlow2 = 3;  // at least 3 rbg per flow (till available resource) to ensure TxOpportunity >= 7 bytes
    }
  uint16_t rbAllocated2 = 0;

  if (m_nextRntiUl2 != 0)
    {
      for (it2 = m_ceBsrRxed2.begin (); it2 != m_ceBsrRxed2.end (); it2++)
        {
          if ((*it2).first == m_nextRntiUl2)
            {
              break;
            }
        }
      if (it2 == m_ceBsrRxed2.end ())
        {
          NS_LOG_ERROR (this << " <Phy2> : no user found");
        }
    }
    ...
    {
      it2 = m_ceBsrRxed2.begin ();
      m_nextRntiUl2 = (*it2).first;
    }
  NS_LOG_INFO (this << "<Phy2>" << " NFlows " << nflows2 << " RB per Flow " << rbPerFlow2);
  do
    {
      std::set <uint16_t>::iterator itRnti2 = rntiAllocated2.find ((*it2).first);
      if ((itRnti2 != rntiAllocated2.end ())||((*it2).second == 0))
        {
          // UE already allocated for UL-HARQ -> skip it
          it2++;
          if (it2 == m_ceBsrRxed2.end ())
      ...
      if (rbAllocated2 + rbPerFlow2 - 1 > m_cschedCellConfig2.m_ulBandwidth)
        {
          // limit to physical resources last resource assignment
          rbPerFlow2 = m_cschedCellConfig2.m_ulBandwidth - rbAllocated2;
          // at least 3 rbg per flow to ensure TxOpportunity >= 7 bytes
          if (rbPerFlow2 < 3)
            {
              // terminate allocation
      ...
      NS_LOG_INFO (this << "<Phy2> : try to allocate " << (*it2).first);
      UlDciListElement_s uldci2;
      uldci2.m_rnti = (*it2).first;
      uldci2.m_rbLen = rbPerFlow2;
      bool allocated2 = false;
      NS_LOG_INFO (this << " <Phy2> : RB Allocated " << rbAllocated2 << " rbPerFlow " << rbPerFlow2 << " flows " << nflows2);
      while ((!allocated2)&&((rbAllocated2 + rbPerFlow2 - m_cschedCellConfig2.m_ulBandwidth) < 1) && (rbPerFlow2 != 0))
        {
          // check availability
          bool free2 = true;
          for (uint16_t j = rbAllocated2; j < rbAllocated2 + rbPerFlow2; j++)
            {
              if (rbMap2.at (j) == true)
                {
                  free2 = false;
          ...
          if (free2)
            {
              uldci2.m_rbStart = rbAllocated2;

              for (uint16_t j = rbAllocated2; j < rbAllocated2 + rbPerFlow2; j++)
                {
                  rbMap2.at (j) = true;
                  // store info on allocation for managing ul-cqi interpretation
                  rbgAllocationMap2.at (j) = (*it2).first;
                  NS_LOG_INFO ("\t " << "<Phy2>" << j);
                }
              rbAllocated2 += rbPerFlow2 ;
              allocated2 = true;
              break;
            }
          rbAllocated2++;
      ...
      std::map <uint16_t, std::vector <double> >::iterator itCqi2 = m_ueCqi2.find ((*it2).first);
      int cqi2 = 0;
      if (itCqi2 == m_ueCqi2.end ())
        {
          // no cqi info about this UE
          uldci2.m_mcs = 0; // MCS 0 -> UL-AMC TBD
          NS_LOG_INFO (this << " <Phy2> : UE does not have ULCQI " << (*it2).first );
        }
      else
        {
          // take the lowest CQI value (worst RB)
          double minSinr2 = (*itCqi2).second.at (uldci2.m_rbStart);
          for (uint16_t i = uldci2.m_rbStart; i < uldci2.m_rbStart + uldci2.m_rbLen; i++)
            {
              if ((*itCqi2).second.at (i) < minSinr2)
                {
                  minSinr2 = (*itCqi2).second.at (i);
                }
            }
          // translate SINR -> cqi: WILD ACK: same as DL
          double s2 = log2 ( 1 + (
                                 std::pow (10, minSinr2 / 10 )  /
                                 ( (-std::log (5.0 * 0.00005 )) / 1.5) ));


          cqi2 = m_amc2->GetCqiFromSpectralEfficiency (s2);
          if (cqi2 == 0)
            {
              it2++;
              if (it2 == m_ceBsrRxed2.end ())
              ...
              NS_LOG_DEBUG (this << " <Phy2> : UE discared for CQI=0, RNTI " << uldci2.m_rnti);
              // remove UE from allocation map
              for (uint16_t i = uldci2.m_rbStart; i < uldci2.m_rbStart + uldci2.m_rbLen; i++)
                {
                  rbgAllocationMap2.at (i) = 0;
                }
              continue; // CQI == 0 means "out of range" (see table 7.2.3-1 of 36.213)
            }
          uldci2.m_mcs = m_amc2->GetMcsFromCqi (cqi2);
        }
      uldci2.m_tbSize = (m_amc2->GetTbSizeFromMcs (uldci2.m_mcs, rbPerFlow2) / 8); // MCS 0 -> UL-AMC TBD

      UpdateUlRlcBufferInfo2(uldci2.m_rnti, uldci2.m_tbSize);
      uldci2.m_ndi = 1;
      uldci2.m_cceIndex = 0;
      uldci2.m_aggrLevel = 1;
      uldci2.m_ueTxAntennaSelection = 3; // antenna selection OFF
      uldci2.m_hopping = false;
      uldci2.m_n2Dmrs = 0;
      uldci2.m_tpc = 0; // no power control
      uldci2.m_cqiRequest = false; // only period CQI at this stage
      uldci2.m_ulIndex = 0; // TDD parameter
      uldci2.m_dai = 1; // TDD parameter
      uldci2.m_freqHopping = 0;
      uldci2.m_pdcchPowerOffset = 0; // not used
      ret2.m_dciList.push_back (uldci2);
      // store DCI for HARQ_PERIOD
      uint8_t harqId2 = 0;
      if (m_harqOn == true)
        {
          std::map <uint16_t, uint8_t>::iterator itProcId2;
          itProcId2 = m_ulHarqCurrentProcessId2.find (uldci2.m_rnti);
          if (itProcId2 == m_ulHarqCurrentProcessId2.end ())
            {
              NS_FATAL_ERROR ("<Phy2> : No info find in HARQ buffer for UE " << uldci2.m_rnti);
            }
          harqId2 = (*itProcId2).second;
          std::map <uint16_t, UlHarqProcessesDciBuffer_t>::iterator itDci2 = m_ulHarqProcessesDciBuffer2.find (uldci2.m_rnti);
          if (itDci2 == m_ulHarqProcessesDciBuffer2.end ())
            {
              NS_FATAL_ERROR ("<Phy2> : Unable to find RNTI entry in UL DCI HARQ buffer for RNTI " << uldci2.m_rnti);
            }
          (*itDci2).second.at (harqId2) = uldci2;
          // Update HARQ process status (RV 0)
          std::map <uint16_t, UlHarqProcessesStatus_t>::iterator itStat2 = m_ulHarqProcessesStatus2.find (uldci2.m_rnti);
          if (itStat2 == m_ulHarqProcessesStatus2.end ())
            {
              NS_LOG_ERROR ("<Phy2> : No info find in HARQ buffer for UE (might change eNB) " << uldci2.m_rnti);
            }
          (*itStat2).second.at (harqId2) = 0;
        }

      NS_LOG_INFO (this << " <Phy2> : UL Allocation - UE " << (*it).first << " startPRB " << (uint32_t)uldci2.m_rbStart << " nPRB " << (uint32_t)uldci2.m_rbLen << " CQI " << cqi2 << " MCS " << (uint32_t)uldci2.m_mcs << " TBsize " << uldci2.m_tbSize << " harqId " << (uint16_t)harqId2);
      ...
      if ((rbAllocated2 == m_cschedCellConfig2.m_ulBandwidth) || (rbPerFlow2 == 0))
        {
          // Stop allocation: no more PRBs
          m_nextRntiUl2 = (*it2).first;
          break;
  ...
  while (((*it2).first != m_nextRntiUl2)&&(rbPerFlow2!=0));
...
RrFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params,
		const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params2)
{
  NS_LOG_FUNCTION (this << "<phy1>");
...
//////// fizo :  modification ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  NS_LOG_FUNCTION (this << "<phy2>");

  std::map <uint16_t,uint32_t>::iterator it2;

  for (unsigned int i = 0; i < params2.m_macCeList.size (); i++)
    {
      if ( params2.m_macCeList.at (i).m_macCeType == MacCeListElement_s::BSR )
        {
          // buffer status report
          // note that this scheduler does not differentiate the
          // allocation according to which LCGs have more/less bytes
          ...
          for (uint8_t lcg = 0; lcg < 4; ++lcg)
            {
              uint8_t bsrId2 = params2.m_macCeList.at (i).m_macCeValue.m_bufferStatus.at (lcg);
              buffer2 += BufferSizeLevelBsr::BsrId2BufferSize (bsrId2);
            }

          uint16_t rnti2 = params2.m_macCeList.at (i).m_rnti;
          it2 = m_ceBsrRxed2.find (rnti2);
          if (it2 == m_ceBsrRxed2.end ())
            {
              // create the new entry
              m_ceBsrRxed2.insert ( std::pair<uint16_t, uint32_t > (rnti2, buffer2));
              NS_LOG_INFO (this << "<phy2>" <<" Insert RNTI " << rnti2 << " queue " << buffer2);
            }
          else
            {
              // update the buffer size value
              (*it2).second = buffer2;
              NS_LOG_INFO (this << "<phy2>" << " Update RNTI " << rnti2 << " queue " << buffer2);
            }
        }
    }
  /////// fizo : modifications end here ^^^^^^^^^^^^^^^
...
RrFfMacScheduler::DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params ,
	                               const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params2)
{
  NS_LOG_FUNCTION (this);
  ...
  switch (params.m_ulCqi.m_type)
    ...
    break;
    case UlCqi_s::PUCCH_1: //* nshelhom mn hna wla la ?
...
// // return;
  ...
  switch (m_ulCqiFilter) // *
    ...
    case FfMacScheduler::SRS_UL_CQI:
      {
        // filter all the CQIs that are not SRS based
        if (params2.m_ulCqi.m_type != UlCqi_s::SRS)
          {
            return;
          }
      }
    ...
    case FfMacScheduler::PUSCH_UL_CQI:
      {
        // filter all the CQIs that are not SRS based
        if (params2.m_ulCqi.m_type != UlCqi_s::PUSCH)
          {
            return;
          }
      }
    ...
    default:
      NS_FATAL_ERROR (" <Phy2> : Unknown UL CQI type");
    }
  switch (params2.m_ulCqi.m_type)
    {
    case UlCqi_s::PUSCH:
      {
        std::map <uint16_t, std::vector <uint16_t> >::iterator itMap2;
        std::map <uint16_t, std::vector <double> >::iterator itCqi2;
        itMap2 = m_allocationMaps2.find (params2.m_sfnSf);
        if (itMap2 == m_allocationMaps2.end ())
          {
            NS_LOG_INFO (this << "<Phy2>" << " Does not find info on allocation, size : " << m_allocationMaps.size ());
            return;
          }
        for (uint32_t i = 0; i < (*itMap2).second.size (); i++)
          {
            // convert from fixed point notation Sxxxxxxxxxxx.xxx to double
            double sinr2 = LteFfConverter::fpS11dot3toDouble (params2.m_ulCqi.m_sinr.at (i));
           itCqi2 = m_ueCqi2.find ((*itMap2).second.at (i));
            if (itCqi2 == m_ueCqi2.end ())
              {
                // create a new entry
                std::vector <double> newCqi2;
                for (uint32_t j = 0; j < m_cschedCellConfig2.m_ulBandwidth; j++)
                  {
                    if (i == j)
                      {
                        newCqi2.push_back (sinr2);
                      }
                    else
                      {
                        // initialize with NO_SINR value.
                        newCqi2.push_back (30.0);
                      }

                  }
                m_ueCqi2.insert (std::pair <uint16_t, std::vector <double> > ((*itMap2).second.at (i), newCqi2));
                // generate correspondent timer
                m_ueCqiTimers2.insert (std::pair <uint16_t, uint32_t > ((*itMap2).second.at (i), m_cqiTimersThreshold2));
              }
            else
              {
                // update the value
                (*itCqi2).second.at (i) = sinr2;
                // update correspondent timer
                std::map <uint16_t, uint32_t>::iterator itTimers2;
                itTimers2 = m_ueCqiTimers2.find ((*itMap2).second.at (i));
                (*itTimers2).second = m_cqiTimersThreshold2;
              }
          }
        // remove obsolete info on allocation
        m_allocationMaps2.erase (itMap2);
      }
      break;
      ...
      case UlCqi_s::SRS:
      {
        // get the RNTI from vendor specific parameters
        uint16_t rnti2 = 0;
        NS_ASSERT (params2.m_vendorSpecificList.size () > 0);
        for (uint16_t i = 0; i < params2.m_vendorSpecificList.size (); i++)
          {
            if (params2.m_vendorSpecificList.at (i).m_type == SRS_CQI_RNTI_VSP)
              {
                Ptr<SrsCqiRntiVsp> vsp = DynamicCast<SrsCqiRntiVsp> (params2.m_vendorSpecificList.at (i).m_value);
                rnti2 = vsp->GetRnti ();
              }
          }
        std::map <uint16_t, std::vector <double> >::iterator itCqi2;
        itCqi2 = m_ueCqi2.find (rnti2);
        if (itCqi2 == m_ueCqi2.end ())
          {
            // create a new entry
            std::vector <double> newCqi2;
            for (uint32_t j = 0; j < m_cschedCellConfig2.m_ulBandwidth; j++)
              {
               double sinr2 = LteFfConverter::fpS11dot3toDouble (params2.m_ulCqi.m_sinr.at (j));
                newCqi2.push_back (sinr2);
                NS_LOG_INFO (this << "<Phy2>" <<" RNTI " << rnti2 << " new SRS-CQI for RB  " << j << " value " << sinr2);

              }
            m_ueCqi2.insert (std::pair <uint16_t, std::vector <double> > (rnti2, newCqi2));
            // generate correspondent timer
            m_ueCqiTimers2.insert (std::pair <uint16_t, uint32_t > (rnti2, m_cqiTimersThreshold2));
          }
        else
         {
            // update the values
            for (uint32_t j = 0; j < m_cschedCellConfig2.m_ulBandwidth; j++)
              {
                double sinr2 = LteFfConverter::fpS11dot3toDouble (params2.m_ulCqi.m_sinr.at (j));
                (*itCqi2).second.at (j) = sinr2;
                NS_LOG_INFO (this << "<Phy2>" << "RNTI " << rnti2 << " update SRS-CQI for RB  " << j << " value " << sinr2);
              }
            // update correspondent timer
            std::map <uint16_t, uint32_t>::iterator itTimers2 ;
            itTimers2 = m_ueCqiTimers2.find (rnti2);
            (*itTimers2).second = m_cqiTimersThreshold2;
...
//-----------modified <Abdelrhman> ----------------//
//-------------------------------------------------//
void RrFfMacScheduler::RefreshUlCqiMaps(void) {
	// refresh UL CQI  Map
	std::map<uint16_t, uint32_t>::iterator itUl = m_ueCqiTimers.begin();

	while (itUl != m_ueCqiTimers.end()) {
		NS_LOG_INFO(this << "First phy" << " UL-CQI for user " << (*itUl).first << " is " << (uint32_t)(*itUl).second << " thr " << (uint32_t)m_cqiTimersThreshold);
		if ((*itUl).second == 0) {
...
//-------------------------------------------------
	 itUl = m_ueCqiTimers2.begin();
		...
		while (itUl != m_ueCqiTimers2.end()) {
			NS_LOG_INFO(this << "Second phy" << " UL-CQI for user " << (*itUl).first << " is " << (uint32_t)(*itUl).second << " thr " << (uint32_t)m_cqiTimersThreshold);
			if ((*itUl).second == 0) {
				// delete correspondent entries
...
void RrFfMacScheduler::UpdateDlRlcBufferInfo(uint16_t rnti, uint8_t lcid,uint16_t size ) {
	NS_LOG_FUNCTION(this);
	std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
	for (it = m_rlcBufferReq.begin(); it != m_rlcBufferReq.end(); it++) {
		if (((*it).m_rnti == rnti)
...
//------Added <Abdelrhman >--------
void RrFfMacScheduler::UpdateDlRlcBufferInfo2(uint16_t rnti, uint8_t lcid,uint16_t size )
{
	NS_LOG_FUNCTION(this);
	std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
	for (it = m_rlcBufferReq2.begin(); it != m_rlcBufferReq2.end(); it++) {
...
void RrFfMacScheduler::UpdateUlRlcBufferInfo(uint16_t rnti, uint16_t size) {
	...
	if (it != m_ceBsrRxed.end()) {
		NS_LOG_INFO(
				this << " Update RLC BSR UE " << rnti << " size " << size << " BSR " << (*it).second);
		if ((*it).second >= size) {
			(*it).second -= size;
		} else {
			(*it).second = 0;
...
//-----Added <Abdelrhman>---------------------
void RrFfMacScheduler::UpdateUlRlcBufferInfo2(uint16_t rnti, uint16_t size){

	size = size - 2; // remove the minimum RLC overhead
	std::map<uint16_t, uint32_t>::iterator it = m_ceBsrRxed2.find(rnti);
	if (it != m_ceBsrRxed2.end()) {
		NS_LOG_INFO(
				this << "<phy2.>.....Update RLC BSR UE " << rnti << " size " << size << " BSR " << (*it).second);
		if ((*it).second >= size) {
			(*it).second -= size;
		} else {
			(*it).second = 0;
...
/*void RrFfMacScheduler::TransmissionModeConfigurationUpdate2(uint16_t rnti,uint8_t txMode) {
	...
	FfMacCschedSapUser::CschedUeConfigUpdateIndParameters params2;
	params2.m_rnti = rnti;
	params2.m_transmissionMode = txMode;
	m_cschedSapUser2->CschedUeConfigUpdateInd(params2);
    }*/
