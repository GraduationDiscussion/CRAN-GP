 ...
 * The cell configuration will also setup the BCH, BCCH, PCCH and CCCH LC configuration*/
  ...
  void DoCschedCellConfigReq (const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params,const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params2);
//-------------------------------------------------------------------
  ...
  void DoCschedUeConfigReq (const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params , const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params2);
//------------------------------------------------------------------------
  ...
  void DoCschedLcConfigReq (const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params , const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params2);
//------------------------------------------------------------------------
  ...
  void DoCschedLcReleaseReq (const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params , const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params2);
//----------------------------------------------------------------------------
  ...
  void DoCschedUeReleaseReq (const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params , const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params2);
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//--------Mod.  end
//=================================================================================================================
...
//			std::map <uint16_t,uint8_t>& m_p10CqiRxedx ,  std::map <uint16_t,uint32_t>& m_p10CqiTimersx);
 // ====================================================
   //-------Modified <Abdelrhman> ---------------------
  void DoSchedDlRlcBufferReq (const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params ,const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params2);
   // ====================================================
...
//=======================================================================================================
  ...
  //-------Modified <Abdelrhman> --------------------------
  void DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params , const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params2);
  // ======================================================
  //-------Modified <Abdelrhman> --------------------------
  ...
  void DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params , const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params2);

  //----------------------------------------------------------------------------------------
  /*Starts the UL MAC scheduler for this subframe*/

  //---Modified <Doha> --------------
  void DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params,const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params2);
 //----------------------------------------------------------------------------------------
  //============================================================
  //----no implement.
...
//----Modified <Doha>------------------------
  void DoSchedUlMacCtrlInfoReq (const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params , const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params2);
//=============================================

  //----Modified <Doha>------------------------
  void DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params , const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params2);
 //=============================================
