...
public:
  ...
  */
  ...
  //________________________ADDED_________________________________//
  LteEnbPhySapUser* GetLteEnbPhy2SapUser ();
//___________________________________________________________________//
  ...
  */
  ...
  //________________________ADDED_____________________________//
  void SetLteEnbPhy2SapProvider (LteEnbPhySapProvider* s);
...
//   std::map <uint16_t,UlInfoListElement_s> m_ulInfoListElements; 
  ...
  //__________________________ADDED_________________________________________//
  LteEnbPhySapProvider* m_enbPhy2SapProvider;
  //________________________________________________________________________//
  LteEnbPhySapUser* m_enbPhySapUser;
  //__________________________ADDED_________________________________________//
  LteEnbPhySapUser* m_enbPhy2SapUser;
