...
LteEnbMac::LteEnbMac ()
{
  ...
  //__________________________ADDED________________________________________//
  m_enbPhy2SapUser = new EnbMacMemberLteEnbPhySapUser (this);
...
//______________________________ADDED__________________________//
  delete m_enbPhy2SapUser;
...
//___________________________________________ADDED__________________________________//
void
LteEnbMac::SetLteEnbPhy2SapProvider (LteEnbPhySapProvider* s)
{
...
//___________________________________________ADDED__________________________________//
LteEnbPhySapUser*
LteEnbMac::GetLteEnbPhy2SapUser ()
{
...
//Do it transmit control /Data or both?!!! should we change sapS
void
LteEnbMac::DoTransmitPdu (LteMacSapProvider::TransmitPduParameters params)
{
  ...
  //________________________ADDED______________________________//
  m_enbPhySapProvider->SendMacPdu (params.pdu);
...
LteEnbMac::DoSchedDlConfigInd (FfMacSchedSapUser::SchedDlConfigIndParameters ind)
{
  ...
  for (unsigned int i = 0; i < ind.m_buildDataList.size (); i++)
    ...
    //_________________________________ADDED_____________________________________________//
                          m_enbPhy2SapProvider->SendMacPdu (pkt);
    //___________________________________________________________________________________//
      ...
      //_________________________ADDED________________________________________//
  ...
  if (ind.m_buildRarList.size () > 0)
    {
      ...
      //____________________________________________ADDED________________________________________//
  ...
  for (unsigned int i = 0; i < ind.m_dciList.size (); i++)
    {
      ...
      m_enbPhySapProvider->SendLteControlMessage (msg);
  //_________________________________ADDED____________________________________//
      m_enbPhy2SapProvider->SendLteControlMessage (msg);
