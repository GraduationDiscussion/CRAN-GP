...
//___________________________ADDED_____________________________________//
...
//____________________________________________________________________//
  ...
  //_____________________________ADDED________________________________//
...
private:
  ...
  //________________________________ADDED_______________________________//
  LteEnbCphySapUser* m_cphy2SapUser;
  //____________________________________________________________________//
  /// Interface to the eNodeB PHY instance.
  LteEnbCphySapProvider* m_cphySapProvider;
  //______________________________ADDED_________________________________//
  LteEnbCphySapProvider* m_cphy2SapProvider;
  //____________________________________________________________________//
