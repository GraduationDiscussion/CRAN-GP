...
///////Chunckprocessor for SNIR/DATA CTRL &POWER CTRL
  ...
  Ptr<LteChunkProcessor> pData = Create<LteChunkProcessor> ();      // Object used to control power of eNB
...
//**************************************************************
  ...
  NS_ASSERT_MSG (mm2, "MobilityModel needs to be set on node before calling LteHelper::InstallUeDevice ()");
...
//**************************************************************
  phy2->SetLteEnbPhySapUser (mac->GetLteEnbPhySapUser ());
  mac->SetLteEnbPhySapProvider (phy2->GetLteEnbPhySapProvider ());

  phy2->SetLteEnbCphySapUser (rrc->GetLteEnbCphySapUser ());
  rrc->SetLteEnbCphySapProvider (phy2->GetLteEnbCphySapProvider ());
//**************************************************************
  //FFR SAP
...
//*******************************************************
  dev->SetAttribute ("LteEnbPhy", PointerValue (phy2));
//*******************************************************
